...
const BLOG = {
  AUTHOR: 'lucifei', // 作者
  BIO: '数码爱好者🍚', // 作者简介
  LINK: 'https://notion.lucifei.de', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'd0268524a348420aaff51082e5b9de7e', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'admin@lucifei.de',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/ltkun',
  CONTACT_TELEGRAM: '',
